    ...
    <div class="mb-6">
      <div class="mb-3">
        ...
        <input
          ...
          id="name" name="name" type="text" placeholder="iPhone" required>
      </div>
      <div class="mb-3">
        ...
        <input
          ...
          placeholder="Le nouveau iPhone 13, avec les mêmes affaires que l'année passée" required>
      </div>
      <div class="mb-3">
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="price">Prix</label>
        <input
          class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-100 transition-colors"
          id="price" name="price" type="number" step="any" placeholder="4.00" required>
        ...
        <label class="" for="image">
          ...
          <div class="flex justify-center items-center w-full mt-2">
            <div
              ...
              <input id="image" name="image" type="file" class="hidden" accept="image/jpeg, image/png" required />
            </div>
          </div>
        </label>
      </div>
