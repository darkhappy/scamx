...
?>
<div class="flex flex-row gap-4 my-4 text-white">
  <form method="post" class="p-8 bg-blue-600 grow rounded-3xl" id="buy">
    ...
    <div class="flex flex-col flex-wrap">
      <div class="mb-6">
        <label for="name" class="block uppercase tracking-wide text-gray-100 text-xs font-bold mb-2">Nom complet</label>
        <input type="text"
               class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
               name="name" id="name" required="" autocomplete="name" placeholder="François Legault">
      </div>
      <div class="mb-6">
        <label for="address" class="block uppercase tracking-wide text-gray-100 text-xs font-bold mb-2">Adresse</label>
        <input type="text"
               class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
    ...
    <div>
      ...
      <div class="mb-3 flex flex-col flex-wrap">
        <div>
